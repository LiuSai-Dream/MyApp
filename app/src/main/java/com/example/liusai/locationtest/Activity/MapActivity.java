...
public class MapActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 定位初始化
        LocationClientOption locationClientOption = getLocationOption();
        mLocClient = new LocationClient(this,locationClientOption);
    ...
    public class MyLocationListenner implements BDLocationListener, OnGetGeoCoderResultListener{
        ...
        public void onReceiveLocation(BDLocation location) {
            // act_map view 销毁后不在处理新接收的位置
            if (location == null || mMapView == null) {
                return;
            }

            //MyLocationData 和 BDLocation 没关系。
            //把BDLocation转换为MyLocationData
            ...
            reverseGeoCodeOption.location(new LatLng(location.getLatitude(),
        ...
        public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
            ...
            Toast.makeText(MapActivity.this, result.getLocation().latitude + " " + result.getLocation().longitude +  " " + result.getAddress(),
                    Toast.LENGTH_LONG).show();
            Log.d(TAG, "The address is " + result.getAddress());
        }
    }
